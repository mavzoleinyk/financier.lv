                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img1.png" alt="image">
                                <span>USA</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img2.png" alt="image">
                                <span>UK</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img3.png" alt="image">
                                <span>New Zealand</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img4.png" alt="image">
                                <span>France</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img5.png" alt="image">
                                <span>Germany</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img6.png" alt="image">
                                <span>Italy</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img7.png" alt="image">
                                <span>Greece</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img8.png" alt="image">
                                <span>China</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img9.png" alt="image">
                                <span>Kuwait</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img10.png" alt="image">
                                <span>Argentina</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img11.png" alt="image">
                                <span>Sweden</span>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-countries-card">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/countries/img12.png" alt="image">
                                <span>Thailand</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6">
                            <div class="ctp-team-card">
                                <div class="team-image">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/team/team1.jpg" alt="image">
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="ctp-team-card">
                                <div class="team-image">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/team/team2.jpg" alt="image">
                                </div>
                                <div class="team-content">
                                    <h3>James Tucker</h3>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="ctp-team-card">
                                <div class="team-image">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/team/team3.jpg" alt="image">
                                </div>
                                <div class="team-content">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="ctp-team-card">
                                <div class="team-image">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/team/team4.jpg" alt="image">
                                </div>
                                <div class="team-content">
                                    <h3>William Pipes</h3>
                    ...
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="ctp-app-image">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/app/app.png" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors1.png" alt="image"></a>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors2.png" alt="image"></a>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors3.png" alt="image"></a>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors4.png" alt="image"></a>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors5.png" alt="image"></a>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-6 col-md-4">
                            <div class="ctp-investors-card">
                                <a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/currency-transfer-provider/investors/investors6.png" alt="image"></a>
                            </div>
                        </div>
                    </div>
                </div>
